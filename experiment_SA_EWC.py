...
# Training function
def train(Shuffle, LR=0.001, Threshold=0.2, Epsilon=1e-4, Power=1):
...
acc1, acc2, acc01 = train(True, LR=0.025) # the same as the optimal SGD optimizer
